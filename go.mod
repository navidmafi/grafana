...
require (
	github.com/grafana/grafana/pkg/build v0.0.0-20250515193652-002f46736a66
	github.com/grafana/grafana/pkg/storage/unified/resourcepb v0.0.0-20250515193652-002f46736a66
)
